  ...
  return (
    ...
    <div>
      ...
      <div className='my-6'>
        ...
        />
        <button
          className='px-8 group disabled:animate-none m-2 btn animate-pulse animate-pulse bg-gradient-to-r from-[#90f5c5] to-[#51DF5F] hover:from-pink-500 hover:to-yellow-500 ...'
          onClick={() => getMetadata()}
          disabled={!publicKey}
		      >
              ...
              <div className='border-t border-gray-200'>
                <dl className='divide-y divide-gray-200'>
                  <>
                    ...
                    <div className='my-6'>
                     <button
                        className='px-8 m-2 btn animate-pulse animate-pulse bg-gradient-to-r from-[#90f5c5] to-[#51DF5F] hover:from-pink-500 hover:to-yellow-500 ...'
